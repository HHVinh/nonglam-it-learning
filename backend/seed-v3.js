...
const sampleVideos = [
  ...
  },
  {
    ...
    courseType: "A",
    order: 9,
    section: "Buổi 2 - Excel (tiếp theo)"
  },
  {
  ...
  },
  {
    ...
    courseType: "A",
    order: 24,
    section: "Buổi 5 - Sửa Bài Tập Excel"
  },
  {
  ...
  },
  {
    ...
    courseType: "A",
    order: 29,
    section: "Buổi 6 - Sửa Bài Tập Excel (tiếp theo)"
  },
  {
  ...
  },
  {
    ...
    courseType: "A",
    order: 34,
    section: "Buổi 7 - Ôn Tập Word, PowerPoint & Trắc Nghiệm"
  },
  {
  ...
  },
  {
    ...
    courseType: "A",
    order: 37,
    section: "Buổi 8 - Sửa Đề Excel Ôn Thi"
  },
  {
  ...
  },
  {
    ...
    courseType: "A",
    order: 41,
    section: "Buổi 9 - Sửa Đề Thi Thử"
  },
  {
    title: "Buổi 10 - Sửa Full Đề Thi Thử 5",
    youtubeId: "a_Ap36QtCig",
    courseType: "A",
    order: 42,
    section: "Buổi 10 - Sửa Đề Thi Thử (tiếp theo)"
  },
  {
    ...
    courseType: "A",
    order: 43,
    section: "Buổi 11 - Ôn Tập Tổng Hợp"
  },
  {
  ...
  },
  {
    ...
    courseType: "B",
    order: 28,
    section: "Buổi 7 - Sửa Đề Ôn Thi Trung Tâm & Trắc Nghiệm"
  },
  {
  ...
  },
  {
    ...
    courseType: "B",
    order: 47,
    section: "Buổi 8 - Sửa Đề Ôn Thi Nâng Cao"
  },
  {
...
const sampleUpdates = [
  { 
    ...
    category: "Tin B",
    date: new Date("2026-05-01T10:00:00Z") // Ngày giả lập tháng 5
  },
  { 
    ...
    category: "Tin B",
    date: new Date("2026-01-01T10:00:00Z") // Ngày giả lập tháng 1
  }
];
...
const seedData = async () => {
  try {
    ...
    console.log("🌱 Rải mầm dữ liệu V3...");
    await Video.insertMany(sampleVideos);
    await UpdateItem.insertMany(sampleUpdates);
    // Nhồi sẵn 3979 view cho đẹp
    await VisitCount.create({ count: 3979 }); 

    console.log("✅ Thành công! Dữ liệu V3 đã sẵn sàng.");
    process.exit();
  } catch (error) {
